class Shop extends GameObject {
    ...
    getOptions() {
        return [
            {
                label: "Huile \xe0 Pizza",
                descriptions: "Soin de faible qualit\xe9",
                right: ()=>{
                    return "200$";
                },
                handler: ()=>{
            ...
            {
                label: "Huile \xe0 Pizza +",
                descriptions: "Soin de moyenne qualit\xe9",
                right: ()=>{
                    return "850$";
                },
                handler: ()=>{
            ...
            {
                label: "Huile \xe0 Pizza +",
                descriptions: "Soin de grande qualit\xe9",
                right: ()=>{
                    return "1550$";
                },
                handler: ()=>{
...
//# sourceMappingURL=index.7d8a9929.js.map
