class Sprite {
    ...
    draw(ctx, cameraPerson) {
        ...
        if (this.shadowLoaded) ctx.drawImage(this.shadow, 0, 0, 32, 32, x, y, 32, 32);
        if (this.imageLoaded) ctx.drawImage(this.image, utils.caseSprite(spriteX), utils.caseSprite(spriteY), 32, 32, x, y, 32, 32);
        this.updateAnimation();
    }
}

//# sourceMappingURL=index.4ba10468.js.map
