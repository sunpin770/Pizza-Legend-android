class Combatant {
    constructor(config, battle){
        ...
        this.notifPizza = new NotifPizza({
            currentPizza: this
        });
    ...
    getPostEvent() {
        ...
        else if (this.specialDamage) return [
            {
                type: "stateChange",
                specialDamage: true,
                onCaster: true,
    ...
    getBuff() {
        if (this.buff?.name === "Moment Chaud") this.buff.buffAtk = 1 + Math.round(this.buff.caster.attackSpe * this.buff.power) / 100;
        ...
        } else if (this.debuff?.name === "Atk -") // Pourcentage
        ...
        if (this[propretry]?.expireIn > 0) {
            ...
            if (this[propretry].expireIn === 0) {
                ...
                return [
                    {
                        type: "textMessage",
                        text: `${expiredEffectName} est finito`
                    }
                ];
            }
        }
...
//# sourceMappingURL=index.d8abab1a.js.map
