...
const nextPosition = function(currentPositionX, currentPositionY, direction) {
    ...
    else if (direction == "left") x -= space;
    else if (direction == "up") y -= space;
    else if (direction == "down") y += space;
    return {
        x,
        y
    };
...
//# sourceMappingURL=index.d01e2d62.js.map
