class Person extends GameObject {
    ...
    updatePostion() {
        if (this.moveProgressRemain > 0) {
            ...
            if (this.moveProgressRemain === 0) utils.createCustomEvent("IFinishWalk", {
                whoId: this.id
            });
        }
    }
    updateSprite(state) {
        ...
        if (!state.movInput && this.moveProgressRemain == 0) this.sprite.setAnimation("stand-" + this.direction);
        if (this.moveProgressRemain > 0) this.sprite.setAnimation("walk-" + this.direction);
    }
...
//# sourceMappingURL=index.288ebcff.js.map
