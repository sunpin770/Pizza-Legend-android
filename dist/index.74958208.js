class Map {
    ...
    async startCutscene(events) {
        ...
        for(let i = 0; i < events.length; i++){
            if (events[i].type === "changeMap") isChangingMap = true;
            ...
            if (result === "LOST_BATTLE" || result === "CLOSED_CRAFT_MENU") break;
        }
        this.cutscenePlaying = false;
    ...
    checkCaseEvent() {
        ...
        } else if (match && !this.cutscenePlaying) this.startCutscene(match.event);
    }
    checkInteraction() {
...
//# sourceMappingURL=index.74958208.js.map
