class GameObject {
    ...
    appear(map) {
        ...
        } else map.addWalls(this.x, this.y);
    ...
    async doBehaviorEvent(map) {
        if (this.behaviorLoop.length === 0 || map.cutscenePlaying || this.isStanding || !this.isAppeared || this.isBehave) return;
        this.isBehave = true;
...
//# sourceMappingURL=index.b2168c60.js.map
