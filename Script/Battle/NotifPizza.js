class NotifPizza {
  ...
  getOptions() {
    ...
    return [
      ...
      {
        label: `Hp: ${this.currentPizza.hp} / ${this.currentPlayerStatePizza.maxHp}`,
        descriptions: "",
        disable: true,
        handler: () => {},
      },
      ...
      {
        label: `Defense.Spe: ${this.currentPlayerStatePizza.defenseSpe}`,
        descriptions: "",
        disable: true,
        handler: () => {},
      },
  ...
  getNextValue() {
    this.nextValue = {
      ...
      defenseSpe:
        this.currentPizza.defenseSpe - this.currentPlayerStatePizza.defenseSpe,
  ...
  getAllOptions() {
    this.allOptions = document.querySelectorAll(
      ".overlayMenu.notifPizza .options button"
    );
